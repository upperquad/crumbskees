...
const phonePage = path.join(__dirname, 'dist/phone/index.html')
const gamePage = path.join(__dirname, 'dist/game/index.html')
const adminPage = path.join(__dirname, 'dist/admin/index.html')
